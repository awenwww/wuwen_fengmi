...
<div class="container" style="text-align: center;margin-top: 25px" >
    <div style="width: 600px;display: inline-block;border: 6px solid #b7bfb8;padding: 25px">
        <h1 style="margin-bottom: 20px;margin-top: 0px">添加用户</h1>
        <form id="form"  method="post" action="${pageContext.request.contextPath}/UserServlet?method=addUser" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-2 control-label">用&nbsp;&nbsp;户&nbsp;&nbsp;名:&nbsp;&nbsp;</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="username" id="userName" placeholder="请输入你的用户名[至少6位]"><span id="message" style="font-size:18px"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" style="font-size: 12px;font-weight: 700">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:</label>
                <div class="radio">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-1">
                        <input type="radio" name="sex" id="blankRadio1" value="男" aria-label="...">男
                    </div>
                    <div class="col-sm-1">
                        <input type="radio" name="sex" id="blankRadio2" value="女" aria-label="...">女
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" name="password" class="form-control" id="mm1" placeholder="请输入你的密码[6-8位]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">确认密码:&nbsp;&nbsp;</label>
                <div class="col-sm-10">
                    <input type="password" name="repassword" class="form-control" id="mm2" placeholder="请确认你的密码"><span id="msg" style="font-size:18px"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">手&nbsp;&nbsp;机&nbsp;&nbsp;号:&nbsp;&nbsp;</label>
                <div class="col-sm-10">
                    <input type="tel" name="phone" class="form-control" id="phone" placeholder="请填写正确的手机号">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:&nbsp;&nbsp;</label>
                <div class="col-sm-10">
                    <input class="form-control" id="mail" type="text" name="mail" placeholder="请填写邮箱地址"><span id="result" style="font-size:18px"></span>
                </div>
            </div>

                <button class="btn btn-primary" type="submit" onclick="validateForm()"  name="submit" value="立即添加">立即添加</button>
...
<%--<form id="form"  method="post" action="${pageContext.request.contextPath}/UserServlet?method=addUser" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-18" data-genuitec-path="/FengMi/WebRoot/before/register.html">
    <div class="regist">
        <div class="regist_center">
            ...
            <div class="regist_main center">
                ...
                <div class="username">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:&nbsp;&nbsp;
                    <select name="sex" class="shurukuang">
                        <option name="sex" value="男"/>男
                        <option name="sex" value="女"/>女
                    </select>
                </div>
