    ...
    <div class="top center">
        <div class="left fl">
            <ul>
                ...
                <li><a href="../after/login.jsp">锋迷网后台管理系统</a></li>
                <div class="clear"></div>
            </ul>
        </div>
        <div class="right fr">
            ...
            <div class="fr">
                <ul>
                    ...
                    <c:if test="${!empty userLogin}">
                        <li><a href="">${userLogin.username}</a></li>
                        <li><a href="">消息通知</a></li>
                    </c:if>
            ...
            success:function(data){
                    ...
                    $(data).each(function(){
                        ...
                        $(goods).each(function(){
                            ...
                            html += '		</a>';
                            html += '	</div>';
                            html += '	<div class="xuangou_right fr"><a href="./xiangqing.html?id=' + this.id + '" target="_blank">选购</a></div>';
                            html += '	<div class="clear"></div>';
                            html += '</div>';
                            html += '</div>';
                        })
